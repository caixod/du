	...
	<form class="form form-horizontal" id="form-user-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $user['title']; ?>" placeholder="" id="articletitle" name="title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">内容：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="editor" name="content" type="text/plain" style="width:100%;height:400px;"><?php echo $user['content']; ?></script> 
			</div>
		</div>
...
$(function(){
    ...
    $('.btn').click(function (ele) {
        ...
        $.ajax({
          url: "<?php echo U('admin/fabu/edit',array('id'=>$user['id']));?>",
          type: 'POST',
          dataType: 'json',
          data: data,
        })
