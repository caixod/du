...
<article class="page-container">
	<form class="form form-horizontal" id="form-user-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $user['username']; ?>" placeholder="" id="articletitle" name="username">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $user['email']; ?>" placeholder="" id="articletitle" name="email">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $user['phone']; ?>" placeholder="" id="articletitle" name="phone">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">微信：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $user['vxin']; ?>" placeholder="" id="articletitle" name="vxin">
			</div>
		</div>
...
$(function(){
    ...
    $('.btn').click(function (ele) {
        ...
        $.ajax({
          url: "<?php echo U('admin/user/edit',array('id'=>$user['id']));?>",
          type: 'POST',
          dataType: 'json',
          data: data,
        })
