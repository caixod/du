    ...
    <form class="form form-horizontal" action="" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input class="input-text size-L" type="text" placeholder="验证码" onblur="if(this.value==''){this.value='验证码:'}" onclick="if(this.value=='验证码:'){this.value='';}" name="yzm" value="验证码:" style="width:150px;">
          <img id="verify"  style="cursor:pointer;" width="100px" height="42px"  class="img"  src="<?php echo U('Home/Login/yanzhengma');?>" onClick="this.src=this.src+'?'+Math.random();" title="看不清楚?点击刷新验证码?"> <a onclick="changeVerify()" id="code" href="javascript:;">看不清，换一张</a> 
        </div>
...
<script>
    ...
    function changeVerify(){
        ...
        img.src       = "<?php echo U('Home/Login/yanzhengma');?>?a="+randomnum;
    }
