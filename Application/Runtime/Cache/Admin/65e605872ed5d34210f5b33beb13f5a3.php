	...
	<div class="mt-20">
		...
		<!-- 			<th width="25"><input type="checkbox" name="" value=""></th> -->
			...
			<!-- 		<td><input type="checkbox" value="" name=""></td> -->
					...
					<td class="td-status"><?php echo $v['vxin']; ?></td>
					<td class="f-14 td-manage">
				<a style="text-decoration:none" class="ml-5" onClick="article_edit('编辑','<?php echo U('admin/user/edit',array('id'=>$v['id'])); ?>','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_del(this,'<?php echo $v['id']; ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
