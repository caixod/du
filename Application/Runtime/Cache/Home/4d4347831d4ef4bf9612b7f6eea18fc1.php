...
<script type="text/javascript" src="/Public/laypage/1.2/laypage.js"></script>
   ...
   //         	var now=(new Date()).getHours();
		...
		<div class="container-fluid">
			<div class="container" >
				<div style="">
					<h3 style="text-align: center;"><?php echo (L("bt1")); ?></h3>
				</div>
			</div>
			<div class="container" >
				<div style="">
					<h3 style="text-align: center;"><?php echo (L("cs")); ?></h3>
				</div>
			</div>
		</div>
    ...
    <div class="container" style="margin: 0 auto;overflow: hidden;padding-top:25px;font-size:14px;">
      <div class="row">
        ...
        <div style="float:right;color:#fff;">
          <a href="<?php echo U('home/login/index');?>" target="_self" style="color: #a2a2a2;text-decoration: none;font-family: 微软雅黑;"><?php echo (L("register")); ?></a>
        </div>
      </div>
    </div>
  </footer>		
