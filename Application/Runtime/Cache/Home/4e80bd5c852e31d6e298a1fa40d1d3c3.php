...
<script type="text/javascript" src="/Public/laypage/1.2/laypage.js"></script>
   ...
   //         	var now=(new Date()).getHours();
	    ...
	    <?php if ($_SESSION['name']) { ?>
   	   		欢迎您注册大赢家服务平台：<?php echo $_SESSION['name']; ?> </a> 
   	   		<a href="<?php echo U('home/login/quit');?>">[退出]</a> 
	    <?php }else{ ?>
			<a href="<?php echo U('home/login/index');?>">[登录]</a>   <a href="<?php echo U('home/register/index');?>">[注册]</a>
	    <?php	} ?>
    ...
    <div class="container" style="margin: 0 auto;overflow: hidden;padding-top:25px;font-size:14px;">
      <div class="row">
        ...
        <div style="float:right;color:#fff;">
          <a href="<?php echo U('home/login/index');?>" target="_self" style="color: #a2a2a2;text-decoration: none;font-family: 微软雅黑;">返回首页</a>
        </div>
      </div>
    </div>
  </footer>		
